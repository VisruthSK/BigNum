rmpfr_test <- function(string_num_1, string_num_2) {
...
test_that("multiplication commutes", {
  ...
  rmpfr_test("11111111", "122333444455555")
  rmpfr_test("122333444455555", "11111111")
})
...
test_that("multiplication big", {
  ...
  rmpfr_test(string_1, string_2)
  rmpfr_test(string_3, string_2)
})
...
test_that("multiplication zero", {
  ...
  rmpfr_test(string_1, "0")
  rmpfr_test(string_2, "0")
  rmpfr_test(string_3, "0")
})
...
test_that("multiplication one", {
  ...
  rmpfr_test(string_1, "1")
  rmpfr_test(string_2, "1")
  rmpfr_test(string_3, "1")
})
